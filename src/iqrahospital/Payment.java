...
public class Payment extends javax.swing.JFrame {
    ...
    public Payment(int mrNumber) {
        initComponents();
        this.mrNumber = mrNumber;
//        this.name = name;
//        LName.setText("Hi " + name);
    }
    ...
    private void initComponents() {
        ...
        payLater.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 1, true));
        ...
        jLabel9.setText("<html><u>Payable Amount: RS:2000</u><html> ");
    ...
    private void payNowActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_payNowActionPerformed
        CreditCard cc = new CreditCard(mrNumber);
        cc.setVisible(true);
